...
void RainGenerator::generateParticle() {
	...
	double posX = std::uniform_real_distribution<double>(origin_.x -radius_, origin_.x + radius_)(rd);//random
	double posY = origin_.y;
	double posZ = std::uniform_real_distribution<double>(origin_.z - radius_, origin_.z + radius_)(rd);
